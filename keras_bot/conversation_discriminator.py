...
# Adaptations to python 3.6: @evilaz
# Some of them:
# Notes: <> is replaced with !=, raw_input with input
...
def init_model():
    ...
    loss = Dense(1, activation="sigmoid")(loss)  # name = 'discriminator output'
...
out = Dense(int(dictionary_size/2), activation="relu")(merge_layer)  # name='relu activation'
out = Dense(dictionary_size, activation="softmax")(out)  # name='likelihood of the current token using softmax activation'
